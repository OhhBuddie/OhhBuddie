        ...
        <div class="left-column">
            <form action="{{ route('products.store' ) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card Sarees"  style="display:none;">
                    ...
                    <div class="row g-3">            
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="work_details" class="form-control select2" style="height:">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="border_type" class="form-control select2" style="height:">
                ...
                <div class="card Gowns" style="display:none;">
                    ...
                    <div class="row g-3">            
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="sleeve_length" class="form-control select2" style="height:">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="sleeve_pattern" class="form-control select2" style="height:">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="closure_type" class="form-control select2" style="height:">
                ...
                <div class="card Tops-Tunics-Kurtis" style="display:none;">
                    ...
                    <div class="row g-3">            
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="bottom_type" class="form-control select2" style="height:">
                ...
                <div class="card Cargos" style="display:none;">
                    ...
                    <div class="row g-3">            
                        ...
                        <div class="col-md-4">
                            <label class="form-label">Waistband Type</label>
                            <input type="text" class="form-control" name="waistband_type" placeholder="Enter Fit Type">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Length</label>
            ...
            @if($cat_id == 88)
                 <div class="card " style="display:block;">
                    <h6 class="card-title">{{$subcat}} Details</h6>
                    <div class="row g-3">            
                    ...
                    <div class="card">
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" id="size_quantity_data" name="stock_quantity">
                            </div>
                            <!--<div class="col-md-4">-->
                            <!--    <label class="form-label">SKU</label>-->
