...
<style>
    .search-container {
        ...
        width: fit-content;
        margin-left: auto; /* Helps position on right side */
    }
    
    .search-input {
        position: absolute;
        right: 50px; /* Ensures space for the icon */
        width: 0;
        height: 36px;
        border: none;
    ...
    @media screen and (max-width: 768px) {
        .search-input.active {
            width: calc(100vw - 80px); /* Adjust width for mobile */
            right: 50px;
            position: absolute;
        }
    }
    ...
    <div class="website-container">
        <div class="fixed-top-container">
            ...
            <marquee class="marq" direction="left">
                ️Delivery In 69 Minutes 🚀 &nbsp;&nbsp;&nbsp;&nbsp;Trendiest Styles Available 👗 &nbsp;&nbsp;&nbsp;&nbsp;Hot Deals From Top Brands 🔥 &nbsp;&nbsp;&nbsp;&nbsp;
                ️Delivery In 69 Minutes 🚀 &nbsp;&nbsp;&nbsp;&nbsp;Trendiest Styles Available 👗 &nbsp;&nbsp;&nbsp;&nbsp;Hot Deals From Top Brands 🔥 &nbsp;&nbsp;&nbsp;&nbsp;
                ️Delivery In 69 Minutes 🚀 &nbsp;&nbsp;&nbsp;&nbsp;Trendiest Styles Available 👗 &nbsp;&nbsp;&nbsp;&nbsp;Hot Deals From Top Brands 🔥 &nbsp;&nbsp;&nbsp;&nbsp;
            </marquee>
            ...
            <div class="container" style="background-color:black; color:white;">
                <div class="row" style="margin-bottom: 70px;">
                    ...
                    <div class="col-md-4 text-md-start mb-2">
                        ...
                        <div class="social-links d-flex flex-column">
                            <span style="color: white; text-decoration:none;"><a href="https://ohhbuddie.com/terms-and-condition" style="color:white; text-decoration:none;">Terms & Conditions</a> | <a href="https://ohhbuddie.com/privacy-policy" style="color:white; text-decoration:none;">Privacy Policy</a> |<a href="https://ohhbuddie.com/return-refund" style="color:white;"> Return & Replacement</a> 
                           | <a href="https://ohhbuddie.com/Shipping-and-Delivery-Policy" style="color:white; text-decoration:none;">Shipping Policy</a></span>
                        </div>
                    </div>
                    <br>
                    <div class="col-md-4 text-md-start mb-2">
                        ...
                        <div class="social-links d-flex flex-column">
                            <span style="color: white; text-decoration:none;"><a href="https://ohhbuddie.com/about-us" style="color:white; text-decoration:none;">About Us</a>  | <a href="https://ohhbuddie.com/contact-us" style="color:white; text-decoration:none;">Contact Us</a></span>
                        </div>
                     ...
                     @if (Auth::check())
                        ...
                        <div class="col-md-4 text-md-start mb-2">
                            ...
                            <div class="social-links d-flex flex-column">
                                <span style="color: white;"><a href="/logout">Logout</a> | Order History |<a href="/wishlist">My Wishlist</a>  | Track Order</span>
                            </div>
                    ...
                    @endif
                        ...
                        <div class="col-md-12 text-md-start mb-2">
                            ...
                            <div class="social-links d-flex flex-column">
                                <span style="color: white;"> Dresses For Girls | T-Shirts | Sandals |  Babydolls | Blazers For Men 
                        ...
                        <div class="col-md-12 text-md-start mb-2">
                            ...
                            <div class="social-links d-flex flex-column">
                                <span>ONLINE SHOPPING MADE EASY AT Ohhbuddie
                                    ...
                                    <p>If you're looking for the best online shopping experience for men, women, and kids in India, you've arrived at the perfect destination. Ohh! Buddie is your one-stop shop for fashion and lifestyle, offering a vast selection of clothing, footwear, accessories, jewellery, personal care products, and more. It's time to redefine your style statement with our exclusive range of trendy and affordable fashion. Enjoy the ease of online shopping and get your favorite styles delivered straight to your doorstep!</p>
                                    
                                    <h3><b>BEST ONLINE FASHION DESTINATION IN INDIA</h3></b>
                                    
                                    <p>Whether you're searching for stylish clothing, trendy footwear, or must-have accessories, Ohh! Buddie combines fashion and functionality for everyone. With limitless outfit options for all occasions, we ensure that you step out in style every day.</p>
                                    
                                    <h3><b>Smart Men’s Fashion</h3></b>
                                    
                                    <p>Upgrade your wardrobe with sleek formal shirts, trendy T-shirts, dapper jeans, and classic kurta-pyjama sets. Add an edge to your look with printed tees, varsity styles, or checkered shirts that pair perfectly with chinos and cuffed jeans. Brave the elements in biker jackets and water-resistant outerwear, and explore our innerwear range for all-day comfort and confidence.</p>
                                    
                                    <h3><b>Trendy Women’s Fashion</h3></b>
                                    
                                    <p>Shopping for women’s fashion at Ohh! Buddie is an exciting experience! Stay comfortable in chinos and printed shorts, turn heads in a little black dress, or embrace nautical fashion with striped tees and dresses. Whether you're drawn to off-shoulder, embroidered, or peplum tops, pair them effortlessly with skirts, palazzos, or skinny-fit jeans. For traditional elegance, explore our sarees, lehenga-choli sets, and salwar-kameez options that make a statement at any event.</p>
                                    
                                    <h3><b>Fashionable Footwear</h3></b>
                                    
                                    <p>Your footwear speaks volumes about your personality, and at Ohh! Buddie, we’ve got something for everyone! From stylish sneakers and loafers to classic brogues and oxfords, your work-to-weekend style is covered. Find running shoes, sports-specific footwear, sandals, sliders, and more. Women can enjoy pumps, heeled boots, and metallic flats that blend comfort with glam.</p>
                                    
                                    <h3><b>Shopping for Kids Made Fun</h3></b>
                                    
                                    <p>Your little ones deserve the best! Explore adorable dresses, ballerina shoes, superhero tees, and fun jerseys. Our wide range of toys ensures playtime is filled with joy and creativity.</p>
