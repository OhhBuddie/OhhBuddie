...
@section('content')
    <style>
        @media (min-width: 768px) {
            .desktop-alert {
                display: block;
                /* Show alert only on larger screens */
            }
        }
    ...
    <div class="container" style="padding-right: 0px; padding-left: 0px;">
        ...
        {{-- <video playsinline autoplay muted loop width="100%">
            <source src="{{ $category2 }}" type="video/mp4" class="catimg" style="width:100%;">
        </video> --}}
        <!--</div>-->
                        ...
                        <div class="input-group">
                            ...
                            <div class="mobile-input-wrapper" style="width:100%">
                                ...
                                <input type="text" placeholder="Enter Your Name" name="name"
                                    style="background-color:transperant; color: #000054; border-color: #000054;" required>
                            </div>
                            @error('mobile_no')
    ...
    <div class="tranding">
        ...
        <div class="tranding-card">
            <img loading="lazy"src="{{ $tranding3 }}" class="catimg" alt="Item 1">
        </div>
