...
<div class="category-container">
    ...
    @foreach ($categories as $category)
        ...
        <div class="category-card">
            <!--<a href="{{ url('/category/' . $encryptedCategory) }}" style="text-decoration:none;">-->
...
<div class="Banner">
                        ...
                        <div class="card-body product-item-card-body text-left">
                            <h8 class="card-title"><b>
                                ...
                                <h8 class="card-title" title="{{ $krti->product_name }}">
                                    {{ Str::limit($krti->product_name, 16, '...') }}
                                </h8>                        
                                <div class="d-flex">
    ...
    <div class="Banner">
             <video  playsinline autoplay muted loop width="100%">
              <source src="https://fileuploaderbucket.s3.ap-southeast-1.amazonaws.com/Home/Category+Banners/Shoe.mp4" type="video/mp4" class="catimg" style="width:100%;">
    ...
    <div class="coupon-container">
        <div class="coupon-card" style="background-color:transparent; border:none">
           <img  loading="lazy"src="https://fileuploaderbucket.s3.ap-southeast-1.amazonaws.com/Home/Promotional+Banners/Banner+1+(1).jpg" alt="Coupon 1">
        </div>
        <div class="coupon-card" style="background-color:transparent; border:none">
           <img  loading="lazy"src="https://fileuploaderbucket.s3.ap-southeast-1.amazonaws.com/Home/Promotional+Banners/Shoe+banner+(1).jpg" alt="Coupon 2">
        </div>
        <!--<div class="coupon-card" style="background-color:transparent; border:none">-->
