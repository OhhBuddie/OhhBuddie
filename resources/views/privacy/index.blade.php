...
<head>
    ...
    <title>Privacy Policy - Fashionsta Technologies Private Limited</title>
...
<body>
    ...
    <div class="container my-5">
        <div class="row">
            <div class="col-12">
                <p>This privacy notice for Fashionsta Technologies Private Limited ('Company', 'we', 'us', or 'our'), describes how and why we might collect, store, use, and/or share ('process') your information when you use our services ('Services'), such as when you:</p>
                <ul>
                    <li>Visit our website at <a href="https://ohhbuddie.com">https://ohhbuddie.com</a>, or any website of ours that links to this privacy notice</li>
                    <li>Engage with us in other related ways, including any sales, marketing, or events</li>
                </ul>
                <p>Questions or concerns? Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a href="mailto:support@ohhbuddie.com">support@ohhbuddie.com</a>.</p>

                <div class="summary-box">
                    <h2 class="section-title">SUMMARY OF KEY POINTS</h2>
                    ...
                    <ul>
                        <li><strong>What personal information do we process?</strong> When you visit, use, or navigate our Services, we may process personal information depending on how you interact with Fashionsta Technologies Private Limited and the Services, the choices you make, and the products and features you use.</li>
                        ...
                        <li><strong>How do you exercise your rights?</strong> The easiest way to exercise your rights is by filling out our data subject request form available here, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.</li>
                    </ul>
                    <p>Want to learn more about what Fashionsta Technologies Private Limited does with any information we collect? Review the full notice below.</p>
                </div>
                ...
                <h3>The personal information you disclose to us</h3>
                ...
                <p><strong>Payment Data.</strong> We may collect data necessary to process your payment if you make purchases, such as your payment instrument number, and the security code associated with your payment instrument..</p>
                <p><strong>Social Media Login Data.</strong> We may provide you with the option to register with us using your existing social media accounts details, like your Facebook, Twitter, or other social media account. If you choose to register in this way, we will collect the information described in the section called 'HOW DO WE HANDLE YOUR SOCIAL LOGINS?' below.</p>
                ...
                <ul>
                    ...
                    <li><strong>Device Data.</strong> We collect device data such as information about your computer, phone, tablet, or other device used to access the Services. Depending on the device used, this device data may include information such as your IP address (or proxy server), device and application identification numbers, location, browser type, hardware model, Internet service provider and/or mobile carrier, operating system, and system configuration information.</li>
                ...
                <ul>
                    ...
                    <li>To evaluate and improve our Services, products, marketing, and your experience. We may process your information when we believe it is necessary to identify usage trends, determine the effectiveness of our promotional campaigns, and evaluate and improve our Services, products, marketing, and your experience.</li>
                ...
                <h2 class="section-title">6. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h2>
                ...
                <h2 class="section-title">7. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
                ...
                <h2 class="section-title">8. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
                ...
                <h2 class="section-title">9. DO WE COLLECT INFORMATION FROM MINORS?</h2>
                <p><strong>In Short:</strong> We do not knowingly collect data from or market to children under 18 years of age.</p>
                <p>We do not knowingly solicit data from or market to children under 18 years of age. By using the Services, you represent that you are at least 18 or that you are the parent or guardian of such a minor and consent to such minor dependent's use of the Services. If we learn that personal information from users less than 18 years of age has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we may have collected from children under age 18, please contact us at <a href="mailto:support@ohhbuddie.com">support@ohhbuddie.com</a>.</p>

                <h2 class="section-title">10. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
                ...
                <p><strong>Cookies and similar technologies:</strong> Most Web browsers are set to accept cookies by default. If you prefer, you can usually choose to set your browser to remove cookies and reject cookies. If you choose to remove cookies or reject cookies, this could affect certain features or services of our Services. To opt out of interest-based advertising by advertisers on our Services visit .</p>
                <p>If you have questions or comments about your privacy rights, you may email us at <a href="mailto:support@ohhbuddie.com">support@ohhbuddie.com</a>.</p>

                <h2 class="section-title">11. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
                ...
                <h2 class="section-title">12. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
                ...
                <h2 class="section-title">13. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
                ...
                <h2 class="section-title">14. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>
                <p>If you have questions or comments about this notice, you may email us at <a href="mailto:support@ohhbuddie.com">support@ohhbuddie.com</a> or by post to:</p>
                <address>
                    Fashionsta Technologies Private Limited<br>
                    2B, Sushil Sen Road, Bhowanipore, Kolkata - 700025
                </address>

                <h2 class="section-title">15. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <p>© 2025 Fashionsta Technologies Private Limited. All rights reserved.</p>
                </div>
            </div>
        </div>
    </div>
